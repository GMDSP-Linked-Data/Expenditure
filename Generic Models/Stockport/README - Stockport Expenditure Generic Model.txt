...
Overview
--------
A Refine project to model Stockport expenditure data. User will need to edit select URIs and labels to ensure dates are appropriately assigned. Using the RDF skeleton on Open Refine, identify the following:
